...
class ProductTagController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = ProductTag::with(['created_by'])->select(sprintf('%s.*', (new ProductTag())->table));
        ...
        return view('admin.productTags.index', compact('users'));
    }
    ...
    public function show(ProductTag $productTag)
    {
        ...
        $productTag->load('created_by', 'tagProducts');
